...
function App() {
  ...
  const [image, setImage] = useState("./al1.jpg")
  ...
  }, [sound, auto, currentT, title, image])
  ...
  return (
    ...
    {/* <Header/> */}
     ...
     <Route path = "/" element = {<Sec5/>} />
      <Route path = "/player" element = {<NeedleDrop image={image} songs = {songs} curTitle = {curTitle} setCurTitle = {setCurTitle} title = {title} sound = {sound} setSound = {setSound} auto = {auto} setAuto = {setAuto} currentT = {currentT} setCurrentT = {setCurrentT} totalT = {totalT} setTotalT = {setTotalT}/>}/>
      <Route path = "/animation" element = {<AnimationPage/>} />
      <Route path = "/music" element = {<InfoPage image={image} setImage={setImage} title = {title} setTitle = {setTitle}/>} />
      ...
      <MiniPlayer image = {image} songs = {songs} curTitle = {curTitle} setCurTitle = {setCurTitle} title = {title} show = {show} setShow = {setShow} sound = {sound} setSound = {setSound} currentT = {currentT} setCurrentT = {setCurrentT} totalT = {totalT} setTotalT = {setTotalT} auto = {auto} setAuto = {setAuto}/>
    </div>
    </Router>
    </>
  );
